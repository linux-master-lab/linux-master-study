...
import Section3_1 from "../../../../../assets/image/sections/sections-list3/Section3/Section3_1.png"
import Section3_2 from "../../../../../assets/image/sections/sections-list3/Section3/Section3_2.png"
import Section3_3 from "../../../../../assets/image/sections/sections-list3/Section3/Section3_3.png"
import Section3_4 from "../../../../../assets/image/sections/sections-list3/Section3/Section3_4.png"
import Section3_5 from "../../../../../assets/image/sections/sections-list3/Section3/Section3_5.png"
        ...
        <SectionTemplate title="리눅스 인터넷 활용">
            ...
            <SectionBlock title="성형">
                <ul className="section-list">
                    ...
                    <div className="photo-wrapper">
                        <img src={Section3_1} alt="" className="photo-image"/>
                    </div>
            ...
            <SectionBlock title="망형">
                <ul className="section-list">
                    ...
                    {/* 사진 */}
                    <div className="photo-wrapper">
                        <img src={Section3_2} alt="" className="photo-image"/>
                    </div>
            ...
            <SectionBlock title="버스형">
                <ul className="section-list">
                    ...
                    {/* 사진 */}
                    <div className="photo-wrapper">
                        <img src={Section3_3} alt="" className="photo-image"/>
                    </div>
            ...
            <SectionBlock title="링형">
                <ul className="section-list">
                    ...
                    {/* 사진 */}
                    <div className="photo-wrapper">
                        <img src={Section3_4} alt="" className="photo-image"/>
                    </div>
            ...
            <SectionBlock title="트리형">
                <ul className="section-list">
                    ...
                    {/* 사진 */}
                    <div className="photo-wrapper">
                        <img src={Section3_5} alt="" className="photo-image"/>
                    </div>
